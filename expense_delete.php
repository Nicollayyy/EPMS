...
// Fetch expense record to display details
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['confirm_delete'])) {
    ...
    if ($stmt->execute()) {
        header("Location: html/expense.php?success=deleted");
        exit;
    } else {
...
<head>
  ...
  <title>Delete Expense | 1028 Tea & Café</title>
        ...
        <div class="col-12 col-lg-6 mx-auto">
          ...
          <div class="panel p-4">
            <div class="panel-head mb-4 text-center">
              ...
              <h4 class="mb-1 text-danger">Delete Expense Record</h4>
            ...
            <div class="alert alert-danger">
              ...
              <strong>Warning:</strong> Are you sure you want to delete this expense record? This action is permanent and cannot be reversed.
            </div>

            <form method="POST" action="">
              <div class="d-flex gap-2 justify-content-center">
                <a href="html/expense.php" class="btn btn-outline-secondary btn-lg">
