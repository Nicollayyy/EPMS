...
// Fetch product record to display details
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['confirm_delete'])) {
    ...
    if ($stmt->execute()) {
        header("Location: html/products.php?success=deleted");
        exit;
    } else {
...
<head>
  ...
  <title>Delete Product | 1028 Tea & Café</title>
        ...
        <div class="col-12 col-lg-6 mx-auto">
          ...
          <div class="panel p-4">
            <div class="panel-head mb-4 text-center">
              ...
              <h4 class="mb-1 text-danger">Delete Product</h4>
            ...
            <div class="alert alert-warning mb-4">
              <h6 class="alert-heading"><i class="fa-solid fa-info-circle me-2"></i>Product Details</h6>
              <hr>
              <div class="row">
                <div class="col-6">
                  <strong>ID:</strong>
            ...
            <div class="alert alert-danger">
              ...
              <strong>Warning:</strong> Are you sure you want to delete this product? This action is permanent and cannot be reversed.
            </div>

            <form method="POST" action="">
              <div class="d-flex gap-2 justify-content-center">
                <a href="html/products.php" class="btn btn-outline-secondary btn-lg">
